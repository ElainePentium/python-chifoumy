...
if picture:
    ...
    if button1:
        ...
        if type(df) == type("toto"):
            ...
            html_python ="<div style='color:#8B4C89;font-size:30px'>Votre geste : python</div>"
            html_spock ="<div style='color:#8B4C89;font-size:30px'>Votre geste : spock</div>"
            chifoudict = {0: html_pierre, 1: html_feuille, 2: html_ciseaux, 3: html_python, 4: html_spock}
